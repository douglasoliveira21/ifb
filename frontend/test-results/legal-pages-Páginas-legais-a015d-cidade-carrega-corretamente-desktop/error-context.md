...
- Name: legal-pages.spec.ts >> Páginas legais e institucionais >> /privacidade carrega corretamente
- Location: e2e\legal-pages.spec.ts:14:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/privacidade
Call log:
  - navigating to "http://localhost:3000/privacidade", waiting until "load"
