...
- Name: legal-pages.spec.ts >> Páginas legais e institucionais >> /doar carrega corretamente
- Location: e2e\legal-pages.spec.ts:39:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/doar
Call log:
  - navigating to "http://localhost:3000/doar", waiting until "load"
