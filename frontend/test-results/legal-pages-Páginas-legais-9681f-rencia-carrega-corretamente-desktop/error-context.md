...
- Name: legal-pages.spec.ts >> Páginas legais e institucionais >> /transparencia carrega corretamente
- Location: e2e\legal-pages.spec.ts:32:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/transparencia
Call log:
  - navigating to "http://localhost:3000/transparencia", waiting until "load"
