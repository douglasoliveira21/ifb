...
- Name: legal-pages.spec.ts >> Páginas legais e institucionais >> /termos carrega corretamente
- Location: e2e\legal-pages.spec.ts:4:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/termos
Call log:
  - navigating to "http://localhost:3000/termos", waiting until "load"
