...
- Name: responsive.spec.ts >> Listagem @ 1440px — no horizontal overflow
- Location: e2e\responsive.spec.ts:24:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/politicos
Call log:
  - navigating to "http://localhost:3000/politicos", waiting until "networkidle"
