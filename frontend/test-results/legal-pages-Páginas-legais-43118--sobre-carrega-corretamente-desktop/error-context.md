...
- Name: legal-pages.spec.ts >> Páginas legais e institucionais >> /sobre carrega corretamente
- Location: e2e\legal-pages.spec.ts:24:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/sobre
Call log:
  - navigating to "http://localhost:3000/sobre", waiting until "load"
